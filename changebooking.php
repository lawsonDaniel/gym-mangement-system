              ...
              echo $task;
                ...
                if(count($rows) >= 1){
                    ...
                    if($active != 1){
                     ...
                     echo $task;
                      ...
                      <div class = "taskcard">
                        ...
                        <div class = "taskcontent">
                          <h3>Edit booking</h3>
                          <form class="changeform" action="./includes/booking.php" method="post">
                      ...
                      <input style="    font-size: 18px;
                           ...
                           background: #505050;
                           color: #fff;
                           border-radius: 5px;" type="date" name="date" value="'.$date.'"  placeholder="plan" required>
                  </div>
                  <div class="form-input-container">
                  <label>
                      Selected Time
                  ...
                  <input style="font-size: 18px;
                           ...
                           background: #505050;
                           color: #fff;
                           border-radius: 5px;" type="time" name="time" value="'.$time.'" placeholder="plan" required>
              </div>
               <div class="form-input-container">
                   <label>
                       Selected instructor
               ...
               <button name="update-booking" style="border: none;
               outline: none;
               background: green;
               /* height: 50px; */
               color: #fff;
               ...
               padding: 10px;
               margin: auto;
               font-size: 20px;">Update booking</button>
               </form>
                        </div>
                      </div>    
                    </div>';
