  ...
  <main>
      ...
      <section class="about" id="about">
          ...
          <div class="about-content">
            <div class="about-img pattern-diagonal-lines-sm gray-lighter">
            ...
            <a href="./signup.php" class="about-btn ">Sign Up</a>
      ...
      <!-- Left contact page --> 
        ...
        <form id="contact-form" action="./includes/contact.php" method="post" class="form-horizontal" role="form">
          ...
          <button name="contact" class="btn btn-primary send-button" id="submit" type="submit" value="SEND">
      ...
      <!-- Left contact page --> 
        <div class="pattern-dots-lg pattern left-contact-container-pic">
